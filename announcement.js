(function() {
    ...
    const IMG_NEW = `<img src="https://esa.ntpc.edu.tw/web-announce/images/new2.svg" alt="最新" class="ann-icon-img icon-new" style="height:18px !important; width:auto !important; margin-left:6px; vertical-align:middle;">`;
