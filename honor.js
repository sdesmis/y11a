(function() {
    ...
    const styles = `
        ...
        .hr-img-box { flex-shrink: 0; width: 220px; height: 155px; position: relative; background: #fff; border: 1px solid #ddd; display: flex; align-items: center; justify-content: center; }
